const App = () => {
  return (
    <div
      className="main-container flex flex-col justify-center items-center max-w-screen max-h-screen h-dvh overflow-hidden pb-4 bg-gradient-to-b from-cyan-500 to-blue-500"
